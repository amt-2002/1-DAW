...
public class App {
	...
	public static void main(String[] args) {
		 ...
		 * for( int i = 0; i < AlumnoArray.length; i++) {
		 * 
		 * if (encontradoIguales) { break; }
		 * 
		 * for( int x = i+1; x < AlumnoArray.length; x++) { if
		 * (AlumnoArray[i].equals(AlumnoArray[x])) {
		 * System.err.println("NO PUEDEN HABER DOS ALUMNOS IGUALES"); encontradoIguales
		 * = true; break; } }
		 * 
		 * }
		 */
