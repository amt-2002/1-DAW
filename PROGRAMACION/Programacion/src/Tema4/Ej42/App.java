...
public class App {
	...
	public static void main(String[] args) {
		...
		equipos.get(0).setCompeticion("Liga Nacional");
		
		System.out.println(equipos.get(1).getCompeticion());
		
		equipos.get(1).setCompeticion("Copa internacional");
		
		System.out.println(equipos.get(0).getCompeticion());
