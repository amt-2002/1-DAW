...
public class App {
	...
	public static void main(String[] args) {
		...
		personajesEquipo1.add(asesino1);
		personajesEquipo1.add(asesino2);
		personajesEquipo1.add(asesino3);
		...
		personajesEquipo1.add(parasito1);
		
		//personajesEquipo1.add(parasito1); -- No añade por duplicidad
		...
		personajesEquipo1.add(parasito2);
		//personajesEquipo1.add(parasito3); -- No añade por maximo de 5 en el equipo
