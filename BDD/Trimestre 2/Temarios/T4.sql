...
SELECT * FROM FUTBOLISTAS WHERE POSICION = 'PORTERO' UNION SELECT * FROM FUTBOLISTAS WHERE POSICION = 'DELANTERO'; -- UNE DOS TABLAS O BASE DE DATOS SIN DUPLICAR DATOS. 

-- INTERSECT

SELECT ESTADIO FROM PARTIDOS INTERSECT SELECT ESTADIO FROM EQUIPOS; -- RELACIONA LA INFORMACION QUE HAY ENTRE LAS DOS TABLAS Y MUESTRA LAS QUE COINCIDEN

-- MINUS 

SELECT ESTADIO FROM PARTIDOS MINUS SELECT ESTADIO FROM EQUIPOS; -- TODO LO QUE COINCIDA CON LA SEGUNDA CONSULTA QUITA LA INFORMACION DEVOLVIENDO LO QUE QUEDA
